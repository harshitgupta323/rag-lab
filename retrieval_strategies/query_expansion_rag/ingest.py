...
def ingest():
    ...
    logger.info("========== QUERY EXPANSION RAG INGESTION STARTED ==========")
    ...
    try:
        ...
        logger.info("========== QUERY EXPANSION RAG INGESTION COMPLETED ==========")

    except Exception:
        logger.exception("Query Expansion RAG ingestion failed")
        raise
