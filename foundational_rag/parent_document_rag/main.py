...
def main():
    ...
    logger.info("Starting Parent Document RAG application")

    print("=" * 60)
    print("          RAG LAB - PARENT DOCUMENT RAG")
    print("=" * 60)
    ...
    try:
        ...
        print("\nFailed to initialize Parent Document RAG system.")
        return
    ...
    while True:
        ...
        try:
            ...
            result = run_rag(retriever, query)
            ...
            print("\n" + "=" * 60)
            print("RETRIEVED PARENT CONTEXT")
            print("=" * 60)
